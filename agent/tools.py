"""
I due tools che l'agent puo' usare.
...
Perche' `lean_explore` esiste separato: nel primo collaudo l'agent ha usato
...
def esegui_lean_explore(codice_lean: str, timeout: int = 240,
    ...
    r = esploratore.explore(codice_lean, timeout=timeout, slot=slot)
    return r.render()
...
def _interprete_python() -> str:
    ...
    librerie dell'agent ne' la sua chiave. L'isolamento non viene dalla
