...
The file `Solution.lean` (Appendix A, {{SOLUTION_LINES}} lines) proves the five
...
**Result:** `Your solution is okay!` for all five theorems ({{VERIFY_SECONDS}} s).
...
```lean
<!--INCLUDE:lean/Solution.lean-->
```

## Appendix B. `Challenge.lean`

```lean
<!--INCLUDE:lean/Challenge.lean-->
```

## Appendix C. `config.json`

```json
<!--INCLUDE:lean/config.json-->
```
