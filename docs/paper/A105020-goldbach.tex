...
% --- fonts and encoding ----------------------------------------------
\usepackage{libertine}                          % text: Linux Libertine (OpenType)
\setmonofont{DejaVuSansMono.ttf}[Scale=0.85,    % code: DejaVu Sans Mono,
  BoldFont=DejaVuSansMono-Bold.ttf,               % upright even inside italics
...
\usepackage{needspace}                          % short headings and listings stay together

% --- mathematics -----------------------------------------------------
\usepackage{amsmath,amssymb,amsthm,mathtools}
\usepackage{unicode-math}
\setmathfont{LibertinusMath-Regular.otf}        % mathematics matched to Libertine
\medmuskip=4mu plus 2mu minus 2mu               % the spaces around + and - never vanish
...
\usepackage{booktabs}
\usepackage{tikz}
\usetikzlibrary{decorations.pathreplacing}      % the figure's brace
