...
> **La pagina principale del repository è [`README.md`](README.md)**: è in
> inglese, scritta per chi non conosce la storia, e dice anche che cosa NON ha
> funzionato. Questa è la versione italiana, più orientata all'uso quotidiano.
> Licenza e attribuzioni: [LICENSE](LICENSE) (Apache 2.0) e [NOTICE](NOTICE).
...
```bash
./.venv/bin/python -m pytest tests/ -v     # circa 6 minuti, 158 test
